...
// 2,1 1
// 3,2 5
function ReceberDoisParams(numero1, numero2) {
    if (numero1 == 0 || numero2 == 0) {
        return -1;
    }
    else if (numero1 > 0 && numero2 > 0) {
        var saida = (numero1 * numero2) - 1;
        return saida;
    }
    else {
        return 0;
...
var lutador0 = new Lutador("Blue Pen", 10, 2);
var lutador1 = new Lutador("Red Pen", 7, 3);
var pararLuta = true;
function Porradaria(lutador0, lutador1, quickAtack) {
    var primeiroLutador;
    var segundoLutador;
